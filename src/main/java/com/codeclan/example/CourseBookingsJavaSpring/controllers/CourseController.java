...
public class CourseController {
    ...
    public ResponseEntity<List<Course>> getAllCourses(@RequestParam(name="starRating", required = false) Integer starRating, @RequestParam(name="name", required = false) String name){
        if (starRating != null){
